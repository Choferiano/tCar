...
const SignupScreen = ({ navigation }) => {
    ...
    const onSubmit = () => {
        try {
            ...
            if(isValidEmail && isCorrectPassword && isRepeatedPasswordCorrect) {
            const request = {
                email,
                password,
        ...
        if (!isRepeatedPasswordCorrect) setErrorConfirmPassword ('Password must match')
    ...
    return (
        <View style={styles.main}>
            <View style={styles.container}>
                <Text style={styles.titleC}>Que esperas</Text>
                ...
                <Pressable style={styles.buttomS} onPress={() => navigation.navigate("Login")}>
                    <Text style={styles.subLink}>Entrar a mi cuenta</Text>
                </Pressable>
            </View>
        </View>
    );
